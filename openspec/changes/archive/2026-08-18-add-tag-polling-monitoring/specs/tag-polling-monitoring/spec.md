...
The polling chain SHALL handle protocol failures without crashing Renderer.
...
- **WHEN** Simulator communication fails and the user later manually connects again after Simulator recovery
- **THEN** polling SHALL be able to resume without restarting the Electron HMI
